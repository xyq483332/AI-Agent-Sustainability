...
def test_sandbox_validate_plugin():
    ...
    valid_meta = {
        ...
        "security": {"network_whitelist": [], "file_read_paths": []},
    }
...
def test_sandbox_file_whitelist():
    ...
    sandbox.restrict_file_access(
        read_paths=["/volume1/docker/qwenpaw/", "/tmp/"], write_paths=["/tmp/output/"]
    )
...
def test_sandbox_audit_log():
    ...
    sandbox.validate_plugin({"name": "test_plugin", "permissions": [], "security": {}})
